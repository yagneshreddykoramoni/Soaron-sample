    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-nav">
          ...
          <a href="#patent" className="footer-link">Patent & Trademark</a>
        </div>
        ...
        <div className="social-icons">
          ...
          <a href="https://www.linkedin.com/company/soaron/posts/?feedView=all" className="social-icon-linkedin" target="_blank" rel="noopener noreferrer">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.instagram.com/SoaronOfficial/" className="social-icon-insta" target="_blank" rel="noopener noreferrer">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="footer-bottom">
        <div className="footer-legal">
          ...
          <span className="footer-separator">•</span>
          <a href="#press" className="footer-legal-link">Press or Media</a>
          <span className="footer-separator">•</span>
          <a href="#help" className="footer-legal-link">Help & Support</a>
        </div>
